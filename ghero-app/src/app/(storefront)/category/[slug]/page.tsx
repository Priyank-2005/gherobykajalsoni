...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const filteredProducts = useMemo(() => {
    // Force category filter to match this page
    let result = DUMMY_PRODUCTS.filter((p) => p.category.slug === category.slug);
    ...
    return result;
  }, [filters, sortValue, category.slug]);
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:py-12">
      ...
      <div className="mb-10 text-center lg:text-left">
        <h1 className="text-4xl lg:text-5xl font-heading text-charcoal mb-4">{category.name}</h1>
        ...
        <div className="flex-1">
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <button
                onClick={() =>
                  setFilters({ categories: [category.slug], sizes: [], colors: [], priceRange: [0, 100000] })
                }
