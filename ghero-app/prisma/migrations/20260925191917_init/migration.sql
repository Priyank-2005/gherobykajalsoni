...
-- CreateEnum
CREATE TYPE "CouponApplyOn" AS ENUM ('CART_VALUE', 'MRP');
...
CREATE TABLE "Coupon" (
    ...
    "applyOn" "CouponApplyOn" NOT NULL,
...
CREATE TABLE "HomepageCategory" (
    ...
    CONSTRAINT "HomepageCategory_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "HomepageReel" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "HomepageReel_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "HomepageCategory_displayOrder_idx" ON "HomepageCategory"("displayOrder");

-- CreateIndex
CREATE INDEX "HomepageReel_displayOrder_idx" ON "HomepageReel"("displayOrder");
...
-- CreateIndex
CREATE UNIQUE INDEX "EmailEvent_eventType_orderId_key" ON "EmailEvent"("eventType", "orderId");

-- CreateIndex
CREATE INDEX "WhatsAppEvent_eventType_idx" ON "WhatsAppEvent"("eventType");

-- CreateIndex
CREATE INDEX "WhatsAppEvent_recipient_idx" ON "WhatsAppEvent"("recipient");

-- CreateIndex
CREATE INDEX "WhatsAppEvent_orderId_idx" ON "WhatsAppEvent"("orderId");

-- CreateIndex
CREATE UNIQUE INDEX "WhatsAppEvent_eventType_orderId_key" ON "WhatsAppEvent"("eventType", "orderId");
...
-- AddForeignKey
ALTER TABLE "HomepageCategory" ADD CONSTRAINT "HomepageCategory_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HomepageReel" ADD CONSTRAINT "HomepageReel_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE SET NULL ON UPDATE CASCADE;
